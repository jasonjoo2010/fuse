...
func NewReadDirPlusFS(clock timeutil.Clock) (fuse.Server, error) {
	fs := &readdirplusFS{
		Clock: clock,
	}
...
func (fs *readdirplusFS) patchAttributes(
...
func (fs *readdirplusFS) StatFS(
	ctx context.Context,
	op *fuseops.StatFSOp) error {
	return nil
}

func (fs *readdirplusFS) LookUpInode(
	ctx context.Context,
...
func (fs *readdirplusFS) GetInodeAttributes(
	ctx context.Context,
...
func (fs *readdirplusFS) ReadDirPlus(
	ctx context.Context,
	op *fuseops.ReadDirPlusOp) error {
	return nil
}

func (fs *readdirplusFS) OpenFile(
	ctx context.Context,
...
func (fs *readdirplusFS) ReadFile(
	ctx context.Context,
